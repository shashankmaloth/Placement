            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-8 bg-white padding-2">
                  ...
                  <hr>
                  <div>
                    <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"> Role: </i> <?php echo $row['role']; ?> </span><span class="margin-right-10"> <i class="fa fa-money text-green"> CTC:</i> <?php echo  $row['package'] . "    "; ?></span> <span class="margin-right-10"><i class="fa fa-calendar text-green"> Drive Date:</i> <?php echo date("d-M-Y", strtotime($row['drive_date'])); ?></span><span class="margin-right-10"><i class="fa fa-location-calendar text-green"> Min CGPA: </i> <?php echo $row['cgpa'] ; ?> </span></p>
                  </div>
                  <div>
                    <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"> Eligibility Criteria: </i> <?php echo $row['qualification']; ?> </span>
                  </div>
                  <div>
