                                    ...
                                    ?>
                                            <div class="col-md-6 latest-job ">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control input-lg" name="drive_date" id="drive_date" value="<?php echo $row['drive_date']; ?>">
                                                </div>
                                            ...
                                            <div class="col-md-6 latest-job ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-lg" id="Eligibility" name="Eligibility" placeholder="Eligibility" value="<?php echo $row['cgpa']; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="city">CTC</label>
                                                    <input type="text" class="form-control input-lg" id="CTC" name="CTC" value="<?php echo $row['package']; ?>" placeholder="CTC">
                                                </div>
                                                <div class="form-group">
