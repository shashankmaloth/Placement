                      ...
                      <div class="box-body no-padding">
                        <div class="mailbox-read-info">
                          ...
                          <h5>From: <?php echo $rowCompany['companyname']; ?>
                            <span class="mailbox-read-time pull-right"><?php echo date("d-M-Y h:i a", strtotime($row['create_date'])); ?></span>
                          </h5>
                        </div>
                          ...
                          <div class="box-body no-padding">
                            <div class="mailbox-read-info">
                              ...
                              <h5>From: <?php if ($rowReply['usertype'] == "company") {
                                ...
                                <span class="mailbox-read-time pull-right"><?php echo date("d-M-Y h:i a", strtotime($rowReply['create_date'])); ?></span>
                              </h5>
                            </div>
                            <div class="mailbox-read-message">
