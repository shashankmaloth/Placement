        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              $sql = "SELECT * FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_company='$_SESSION[id_company]' AND apply_job_post.status=2";
              ...
              ?>
                  <div class="attachment-block clearfix padding-2">
                    ...
                    <div class="attachment-text padding-2">
                      <div class="pull-left"><i class="fa fa-calendar"></i> <?php echo $row['drive_date']; ?></div>
                      <?php
