              ...
              <div class="row">
                <form method="post" action="addpost.php">
                  <div class="col-md-12 latest-job ">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control  input-lg" id="package" autocomplete="off" name="package" placeholder="CTC" required="">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control  input-lg" id="cgpa" name="cgpa" placeholder="Minimum CGPA" required="">
                    </div>
                    <div class="form-group">
                      <input class="form-control  input-lg" id="role" autocomplete="off" name="role" placeholder="Role" required="">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control  input-lg" id="qualification" name="qualification" placeholder="Eligibility Criteria" required="">
                    </div>
                    <div class="form-group">
                      <input type="date" class="form-control  input-lg" id="cdate" name="cdate" placeholder="drive date" required="">
                    </div>
