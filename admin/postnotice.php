...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO notice (subject, notice, audience, file, hash, `date`) VALUES ('$subject', '$input', '$audience', '$file', '$hash', now())";
            ...
            <section>
                ...
                <form class="centre" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="file" class="form-group">
                        ...
                        <input type="file" name="notice" class="btn btn-flat btn-primary" required>
                    </div>
                    <br>
                    ...
                    <div class="form-group text-center option">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" name="audience" required>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <?php if ($row['file'] != '') { ?>
                                            <td><a href="../uploads/notice/<?php echo $row['file']; ?>" download="<?php echo 'Notice'; ?>"><i class="fa fa-file"></i></a></td>
                                        <?php } else { ?>
                                            <td>No notice Uploaded</td>
                                        <?php } ?>
