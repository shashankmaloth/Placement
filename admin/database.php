        ...
        <div class="content-wrapper" style="margin-left: 0px;">
            ...
            <section id="candidates" class="content-header">
                <div class="container">
                    ...
                    $sql1 = "SELECT DISTINCT jp.jobtitle 
                            FROM job_post jp
                            INNER JOIN apply_job_post ajp ON jp.id_jobpost = ajp.id_jobpost
                            INNER JOIN users u ON u.id_user = ajp.id_user
                            WHERE ajp.id_company = (SELECT id_company FROM job_post WHERE id_jobpost = jp.id_jobpost)";
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <table id="example2" class="table table-hover">
                                                <thead>
                                                    ...
                                                    <th>Email</th>
                                                    <th>SSC</th>
                                                    <th>Intermediate/Diploma</th>
                                                    <th>CGPA</th>
                                                    <th>Status</th>
                                                    <th>Downlad Resume</th>
