              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Applications Submitted</span>
                      <?php
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Drives Participated</span>
                      <?php
                      $sql = "SELECT DISTINCT id_jobpost FROM apply_job_post WHERE id_user='$_SESSION[id_user]'";
                      $result = $conn->query($sql);
