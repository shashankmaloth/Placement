                ...
                ?>
                    <div class="row">
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          <label for="Marks">Intermediate/Diploma</label>
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          <label for="Marks">Current CGPA</label>
                          <input type="text" class="form-control input-lg" id="Marks" name="ug" placeholder="CGPA" value="<?php echo $row['ug']; ?>">
                        </div>
                        <div class="form-group">
